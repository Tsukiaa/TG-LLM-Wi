...
def SFT_with_LoRA(model, tokenizer, output_dir, formatting_func, data_train, data_val, batch_size,
                  max_seq_length, max_steps, resume_from_checkpoint=None,
                  collator=None):
    # lora config
    ...
    training_args = transformers.TrainingArguments(
                ...
                max_steps=max_steps,
                # max_length=max_seq_length,  # 设置序列的最大长度
